...
let package = Package(
    name: "Verint-XM-Digital-Journey",
    platforms: [
        .iOS(.v12)
    ],
    products: [
        .library(name: "Verint-XM-Digital-Journey", targets: ["EXPSurveyManagement", "EXPCore", "EXPPredictive", "EXPIngestionLogger", "EXPUtilities"])
    ],
    targets: [
